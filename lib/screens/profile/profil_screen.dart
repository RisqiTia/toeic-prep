...
class _ProfilScreenState extends State<ProfilScreen> {
  ...
  Future<void> _saveName() async {
    ...
    if (result['status'] == 'success') {
      ...
      _showTopNotif(result['message'] ?? 'Gagal memperbarui nama', isError: true);
    }
  }
  ...
  Future<void> _pickAndUpload(ImageSource source) async {
    ...
    if (result['status'] == 'success') {
      ...
      _showTopNotif(result['message'] ?? 'Gagal mengunggah foto', isError: true);
    }
  }
            ...
            child: SingleChildScrollView(
              ...
              child  : Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  _ReadOnlyField(icon: Icons.email_outlined, value: widget.userEmail),
        ...
        child   : FadeTransition(
          ...
          child  : Material(
            ...
            child       : Container(
              ...
              decoration: BoxDecoration(
                color       : widget.isError ? const Color(0xFFEF4444) : const Color(0xFF2563EB),
                borderRadius: BorderRadius.circular(12),
                boxShadow   : [
                  BoxShadow(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(value, style: const TextStyle(fontSize: 14, color: Color(0xFF1A1A2E))),
        ],
      ),
    );
  }

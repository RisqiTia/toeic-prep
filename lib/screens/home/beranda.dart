          ...
          children    : [
            ...
            RichText(
              ...
              text     : TextSpan(
                ...
                children: const [
                  TextSpan(text: 'Simulasi ini menyerupai tes TOEIC internasional dengan durasi '),
                  TextSpan(text: '2 jam.', style: TextStyle(fontWeight: FontWeight.bold)),
                ],
              ),
            ),
            const SizedBox(height: 16),
                ...
                Expanded(
                  child: OutlinedButton(
                    ...
                    style    : OutlinedButton.styleFrom(
                      ...
                      side   : const BorderSide(color: Color.fromARGB(255, 196, 194, 194)),
                    ),
                    child: const Text(
                      'Batal',
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => SimulasiScreen(userId: userId)),
                      );
                    },
